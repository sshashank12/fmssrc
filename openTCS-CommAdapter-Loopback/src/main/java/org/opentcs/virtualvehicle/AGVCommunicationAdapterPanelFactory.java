 ...
 * @author zisha
 */
public class AGVCommunicationAdapterPanelFactory implements VehicleCommAdapterPanelFactory {

  /**
   * This class's logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(AGVCommunicationAdapterPanelFactory.class);
  /**
   * The service portal.
   */
   ...
   */
  @Inject
  public AGVCommunicationAdapterPanelFactory(KernelServicePortal servicePortal,
