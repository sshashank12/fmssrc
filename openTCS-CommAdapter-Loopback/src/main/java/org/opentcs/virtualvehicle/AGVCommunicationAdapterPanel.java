 ...
 * @author zisha
 */
public class AGVCommunicationAdapterPanel  extends org.opentcs.drivers.vehicle.VehicleCommAdapterPanel {
   ...
   * This class's Logger.
   */
  private static final Logger LOG = LoggerFactory.getLogger(AGVCommunicationAdapterPanel.class);
  /**
   * The object service.
   */
   ...
   */
  private final AGVCommAdapter commAdapter;
  /**
   ...
   */
  @Inject
  AGVCommunicationAdapterPanel(TCSObjectService objectService,
                                    @Assisted AGVCommAdapter adapter) {
